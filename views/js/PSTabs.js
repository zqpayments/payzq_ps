...
;(function(window) {
	...
	PSTabs.prototype._init = function() {
		// get current index
		this.index = Number(document.URL.substring(document.URL.indexOf("#payzq_step_") + 13));
		// tabs elems
	...
	var div_3d = Translation[0]+' </br>- '+Translation[1]+' </br>- '+Translation[2]+'<a href="https://support.PayZQ.com/questions/does-PayZQ-support-3d-secure-verified-by-visa-mastercard-securecode" target="_blank">https://support.PayZQ.com/questions/does-PayZQ-support-3d-secure-verified-by-visa-mastercard-securecode</a></div>';
